...
public class BackStackTest {
    ...
    @Test
    public void backStackTest() {
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.fragment_switching_from_activity), withText("Fragment switching from activity"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView4 = onView(
                allOf(withText("FrogmentExample"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("FrogmentExample")));
